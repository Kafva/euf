# 0 "tests/smack_driver.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "tests/smack_driver.c"
# 1 "tests/cprover_builtin_headers.h" 1

# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/11.2.0/include/stdbool.h" 1 3 4
# 3 "tests/cprover_builtin_headers.h" 2
...
# 4 "tests/cprover_builtin_headers.h" 2


 
# 6 "tests/cprover_builtin_headers.h"
typedef 
# 6 "tests/cprover_builtin_headers.h" 3 4
        _Bool 
# 6 "tests/cprover_builtin_headers.h"
             __CPROVER_bool;
 typedef size_t __CPROVER_size_t;
 typedef ssize_t __CPROVER_ssize_t;
