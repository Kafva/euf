...
; set_to true (equal)
(define-fun |__CPROVER_max_malloc_size#1| () (_ BitVec 64) (_ bv2251799813685248 64))
...
(define-fun |B1| () Bool (= |euf_main::$tmp::return_value_nondet_int!0@1#1| |euf_main::$tmp::return_value_nondet_int!0@1#1|))

; find_symbols
(declare-fun |euf_main::1::y!0@1#1| () (_ BitVec 32))
; convert
; Converting var_no 2 with expr ID of =
(define-fun |B2| () Bool (= |euf_main::1::y!0@1#1| |euf_main::1::y!0@1#1|))

; find_symbols
(declare-fun |euf_main::$tmp::return_value_nondet_int$0!0@1#1| () (_ BitVec 32))
; convert
; Converting var_no 3 with expr ID of =
(define-fun |B3| () Bool (= |euf_main::$tmp::return_value_nondet_int$0!0@1#1| |euf_main::$tmp::return_value_nondet_int$0!0@1#1|))

; find_symbols
(declare-fun |euf_main::$tmp::return_value_sum!0@1#1| () (_ BitVec 32))
; convert
; Converting var_no 4 with expr ID of =
(define-fun |B4| () Bool (= |euf_main::$tmp::return_value_sum!0@1#1| |euf_main::$tmp::return_value_sum!0@1#1|))
