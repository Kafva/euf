...
// We would need to include both the old and new version of the main header
#include "oniguruma_new.h"
#include "oniguruma_old.h"

//extern int onig_number_of_captures_old(regex_t* reg);
...
int main(int argc, char* argv[]){
	...
	int res1 = onig_number_of_captures_old(reg1);
